...
mongoose.Promise = global.Promise; //mpromise is deprecated, use native ES6 promises
var Loc = mongoose.model('Location'); //instantiate the model
...
//http://localhost:3000/api/locations?lng=-0.79925&lat=51.37809&dis=50
module.exports.locationsListByDistance = function(req, res) {
    var lng = parseFloat(req.query.lng);
    var lat = parseFloat(req.query.lat);
    var dis = parseInt(req.query.dis);
    var point = {
        type: "Point",
        coordinates: [lng, lat]
    };
    ...
    //geoNear gets executed immediately, no need for exec()
...
module.exports.locationsCreate = function(req, res) {
    var facilities = req.body.facilities && req.body.facilities.split(',') || [];
    Loc.create({
        name: req.body.name,
